...
part_type_color_rgb(pt3,238,238,26,26,38,38)
...
part_type_speed(pt3,0.2,0.6,0,0) // скорость min и max(0.2,2)  Дальше указываем приращение скорости(+0.3) и колебание(я поставил 0)
...
part_emitter_burst(ps,em,pt3,10)
