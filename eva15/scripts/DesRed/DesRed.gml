...
part_system_depth(pt3,800)
part_type_shape(pt3,pt_shape_square) // устанавливаем вид частиц
part_type_color_rgb(pt3,187,222,0,133,255,255)
part_type_life(pt3,30,50) /// время жизни частиц. min и max ( 40 и 50) Время считается в шагах игры
//part_type_alpha1(pt3,random_range(0.05,0.1)) /// Так ей можно задать прозрачность равной (0.05)
part_type_speed(pt3,1,3,0,0) // скорость min и max(0.2,2)  Дальше указываем приращение скорости(+0.3) и колебание(я поставил 0)
